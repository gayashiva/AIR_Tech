...
\caption{ The discharge rate measured by the automation system (red line) and the modelled discharge rate of the
HIV forced model (blue line) are compared. The dashed grey line represents the minimum discharge rate that does
not trigger fountain freezing events. }
...
\section{Applications of model forcings}\label{sec:SEB}
