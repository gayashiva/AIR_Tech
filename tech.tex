...
would increase the maintenance cost due to higher risk of fountain freezing events and may compromise the
maximum ice volume obtained due to reduction in the fountain spray radius.

An optimum construction strategy, therefore, should first prevent the occurrence of these two events before
reducing discharge rates. Fountain freezing events can be prevented if the discharge is not lowered below a
minimum threshold. The spray radius can be maintained once the driving factors determining its value are
identified.
...
water-use efficiency and maximum ice volume obtained from different fountain scheduling strategies.
...
volumes.  Future research must be devoted to engineer such fountain automation systems that create larger AIRs
