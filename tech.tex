...
The recommended discharge rates are sensitive to the expected spray radius of the fountain. For example, an
increase of 0.1 m in the expected spray radius increases the median recommended discharge rate from ? to ?.
