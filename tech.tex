...
that the corresponding energy flux increased or decreased freezing or melting energy, respectively.
The radiation fluxes contributed -6 \% and 5 \% to the freezing and melting energies for the traditional and
automated AIR, respectively.  Similarly, the turbulent fluxes contribute -9 \% and -9 \% to the freezing
...
\begin{table}
  ...
  simulation duration for the automated and the traditional AIRs}
	...
	\begin{tabular}{@{}|llllll|@{}}
		...
		\multicolumn{1}{|l|}{} & Rain heat                       &  $q_{R}$        & $10$  & $1$     & \% \\
...
increasing the water-use efficiency up to 60 \%. 
...
AIR are underestimated since the model ignores spray radius variations caused by the discharge rate. The
observed spray radius represents the median discharge rate of the fountain used as shown in Fig. \ref{fig:radf}
...
pressure loss is expected to increase exponentially as discharge increases further decreasing the expected spray
radius. Therefore, only limited control of height and radius of the AIR is possible using this strategy.
