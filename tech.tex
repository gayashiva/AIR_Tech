...
since the unscheduled fountain's discharge duration was 2 times higher.
...
The unscheduled fountain was interrupted by a fountain freezing event. This fountain freezing event was
triggered almost immediately after the fountain height was increased even though the fountain discharge had
attained the critical discharge rate as shown in Fig. \ref{fig:aws}. Therefore, the freezing event could have
been prevented by ensuring proper drainage and avoiding fountain height increase events after attaining critical
discharge rate. 
...
\subsection{Benefits of scheduled fountains}
...
automated AIRs increases and decreases depending on whether the ICV scheduling strategy or the WUE scheduling
strategy is used. 
...
Between the WUE and ICV strategies, 
