...
\begin{abstract}
  ...
  efficiency (WUE). This can be achieved by the precise scheduling of the water spray taking into account the
  AIRs response to weather conditions. Particularly in the light of climate change with rising dependence on
  this water storage technology, an optimal solution for this task is of paramount importance. We solve the
  corresponding optimization problem, i.e. finding the ideal discharge rate for maximum WUE by an approach which
  offers straightforward application facilities. The automation software uses a simplified equation with 6
...
increased water needs. However, their water use efficiency (WUE) is very poor. Among the most promising current
strategies to increase AIR WUE is the use of automated fountain scheduling systems, which facilitate water
management due to the highly localized discharge of water, i.e. by applying the right amount of water at the
right time over the winter season.
