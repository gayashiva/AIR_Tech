...
\subsection{CH22 vs CH21 AIRs}

The maximum volume of CH21 AIR was more than twice that of traditional CH22 AIR. Since both AIRs used the same
water source and fountain, they are expected to have the same fountain characteristics. However, the measured
spray radius of the CH22 fountain is smaller than the CH21 fountain by more than 2 $m$. If they were the same,
the maximum volume of both the AIRs correspond well. This implies that there are other factors besides the
enginnering design of the fountain used that determine its spray radius.

Manual measurements of the fountain spray revealed a maximum spray radius of just 3 m but drone measurements
reveal a fountain spray radius of 4.8 m for the scheduled fountain. This discrepancy could be caused by wind
drift of water droplets.
...
The relationship of fountain spray radius to the wind speed and the engineering design of fountains needs
further examination. We show that lower wind speeds produced smaller AIRs in Guttannen when compared to last
winter. 

AIRs produced in Guttannen this winter were only half the volume of AIRs produced last winter. We hypothesize
that this was mainly due to the lower wind speed during the construction period. However, further examination is
required to quantify the role of wind in achieving a higher fountain spray radius for the CH21 AIR.
