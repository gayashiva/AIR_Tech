...
a correlation around 0.5 and a RMSE less than 0.7 $l/min$ and 1.7  $l/min$ respectively. The weather-sensitive
fountain overestimated the freezing rate 74 \% of the construction duration whereas the water-sensitive fountain
overestimated the freezing rate 60 \% of the construction duration as illustrated by Fig. \ref{fig:simvsreal}.
Therefore, the IVOM model forcing was successful in prioritizing the maximum ice volume but the WEOM model
forcing could not optimize for water use efficiency. However, this large overestimation could be due to the
depression of the unscheduled fountain's freezing rate caused by its excess discharge rate. 
...
The volume estimation for the automated and traditional AIR had an RMSE of 13 $m^3$ and 7 $m^3$ with the drone
volume observations, respectively. This RMSE error is within 20 \% and 19 \% of the maximum volume of the
