...
with aperture diameter. We know that without the fountain nozzle the diameter is 19 $mm$ and the pressure loss
is zero. Also, we know that scheduled fountain had a pressure loss of 4.3 $m$ with an aperture diameter 5 $mm$
and height 4 $m$. Using these two evaluations, we estimate that for a constant height the pressure decreases by
18 $mm$ for every 1 $mm$ increase in aperture diameter (see Fig. \ref{fig:fountains} (a)).

We know that the unscheduled fountain had a fountain freezing event at height 5.7 $m$. We can assume that its
discharge rate was close to zero during this event. Therefore, given the unscheduled fountain's aperture
diameter, its discharge rate profile has to be zero above 5.7 $m$ and it has to be related to the discharge rate
profile of the scheduled fountain using Eqn. \ref{eqn:bernoulli} . The aperture diameter candidate that
satisfies both these conditions is 7 $mm$ as shown in Fig. \ref{fig:fountains} (a) and (b) .
...
maximum spray radius of just 3 m but drone measurements reveal a maximum spray radius of 4.8 m for the scheduled
fountain. This discrepancy could be caused by both wind drift of water droplets and refreezing events across the
boundary of the AIR. 

However, spray radius varies drastically with both the height and discharge rate of the fountain. To circumvent
this issue, we define the fountain spray radius $r$ to be produced during time periods when the fountain has
attained its maximum height and discharge rate. 
