...
motion starting from a fountain height $h$ with a launch angle $\theta = 45 \degree$ and impacting the ground at
a distance $r$, we get the following horizontal and vertical equations of motion respectively:
...
\subsection{Operation of automation system}


\subsection{AIR shape variation with fountain characteristics}

Fig. (a) shows the estimated height of the traditional and automated AIR. The heights of both the AIR arre
underestimated since the model assumes a constant fountain spray radius estimated from the drone observations.
The observed spray radius represents the median discharge rate of the fountain used as shown in Fig. (b).
Therefore, the traditional AIR had a higher radius and height primarily because of its higher discharge rate
compared to the automated AIR.
